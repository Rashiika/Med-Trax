...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white border border-blue-300 px-4 sm:px-6 lg:px-10">
      <div className="text-center mb-10">
        ...
        <h2 className="text-[#26A09B] font-inter text-[3rem] not-italic font-semibold leading-normal">
          Welcome to Med-trax
        </h2>
        <p className="text-black font-inter text-[2rem] not-italic font-normal leading-normal">
      ...
      <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 mb-10">
        ...
        >
          ...
          <p className="mt-3 text-blue-700 text-lg sm:text-xl font-semibold">
            Doctor
          </p>
          {selectedRole === "doctor" && (
            <div className="absolute -bottom-3 bg-[#20AA14] text-white rounded-full w-6 h-6 flex items-center justify-center shadow-md">
              ✓
            </div>
          )}
        </div>
